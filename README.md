...
Das Plugin, das auch als ZIP gepackaged ist findest du im aktuellen [Release](https://github.com/opengisch/ch.bs.urkataster/releases/latest) zu downloaden. Der Sourcecode ist [hier](urkataster-tools/). Ebenso wird die Benutzerdoku über den Release publiziert.
